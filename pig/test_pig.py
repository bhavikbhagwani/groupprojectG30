...
class TestGameClass(unittest.TestCase):
    ...
    def test_player_cheats(self):
        ...
        self.assertTrue(game_test.cheats_used)
        self.assertGreater(game_test.player_1.num_rounds, current_num_rounds)
        self.assertGreater(game_test.player_1.score, current_score)
        self.assertEqual(game_test.player_1.current_round_score, 0)
